...
import top.wml.train.business.domain.TrainSeatExample;
import top.wml.train.business.mapper.TrainSeatMapper;
import top.wml.train.business.req.TrainSeatQueryReq;
import top.wml.train.business.req.TrainSeatSaveReq;
import top.wml.train.business.resp.TrainSeatQueryResp;
...
public class TrainSeatService {
    ...
    public void genTrainSeat(String trainCode){
        ...
        for (TrainCarriage trainCarriage : carriageList) {
            ...
            // 根据车厢类型，筛选出所有的列，比如车厢类型是一等座，则筛选出columnList={ACDF}
